...
let ufos;
//Asteroids
const ASTEROIDS_GROUP_SIZE = 200;
let asteroids;
//Random appearance
...
const LEVEL_ASTEROIDS_PROBABILITY = [0.05, 0.1, 0.15, 0.2, 0.25];
const LEVEL_ASTEROIDS_VELOCITY = [12.5, 25, 37.5, 50, 72.5];
...
class Hud {
    constructor(_posX, _posY) {
        ...
        this.hudShip.src = "assets/imgs/craft.png";
    }
}
